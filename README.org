...
很多配置来源于Github、Emacs China 等。
* 系统判定

判断是否为Windows、Linux、Macos。
方便后续SIS等包使用。
以及，windows有编码问题。需要
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq package-archives '(("gnu" . "http://mirrors.tuna.tsinghua.edu.cn/elpa/gnu/")
                           ...
                           ("melpa" . "http://mirrors.tuna.tsinghua.edu.cn/melpa/")
...
* 主题
目前使用的是doom-theme中的doom-one-light
...
*insert* 用来加粗。（类似于markdown中的C-b，给选中的文字加粗）
...
set-mark-command ，C-spc 可以在当前mark
C-u C-spc 可以跳回上一个mark的地方。
